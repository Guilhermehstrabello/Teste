    ...
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <header className="bg-gray-100 flex md:flex-col flex-row md:gap-5 items-center justify-center md:px-5 w-full">
          <div className="flex flex-row gap-2 items-center justify-start md:ml-[0] ml-[105px] md:mt-0 my-[30px] w-auto">
            <Img
            ...
            />
            <Img
              className="h-5 w-[111px]"
              src="images/img_nexcent.svg"
              alt="nexcent"
            />
          </div>
          <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[166px] md:mt-0 my-[30px] w-[41%] md:w-full">
            <div className="flex sm:flex-col flex-row gap-[50px] items-center justify-center w-auto sm:w-full">
          ...
          <div className="flex sm:flex-col flex-row gap-3.5 items-start justify-start md:ml-[0] ml-[124px] mr-[120px] md:mt-0 my-[22px] w-auto">
            <Button
        ...
        <div className="flex flex-col gap-10 items-start justify-start w-auto md:w-full">
          ...
          <div className="flex flex-col gap-4 items-start justify-start w-auto md:w-full">
            ...
            >
              <div className="bg-white-A700 flex flex-col gap-2 items-center justify-start md:px-5 px-8 py-6 rounded-lg shadow-bs w-[299px]">
                <div className="flex flex-col gap-4 items-center justify-start w-[267px]">
                  ...
                  />
                  <Text
                    className="leading-[36.00px] max-w-[267px] md:max-w-full sm:text-2xl md:text-[26px] text-[28px] text-center text-gray-800"
                    size="txtInterBold28"
                  >
        ...
        <div className="flex flex-col gap-12 items-start justify-center mt-[42px] w-auto md:w-full">
            ...
            >
              <div className="md:h-[286px] h-[366px] relative w-[368px]">
                <Img
                  ...
                  alt="imageEighteen"
                />
                <div className="absolute bg-gray-100 bottom-[0] flex flex-col gap-4 inset-x-[0] items-center justify-start mx-auto p-4 rounded-lg shadow-bs1 w-auto">
                  <Text
                  ...
                  <div className="flex flex-row gap-2 items-center justify-center p-2 w-full">
                    <Text
                      className="text-green-500 text-xl w-auto"
                      size="txtInterSemiBold20"
                    >
        ...
        <footer className="flex items-center justify-center mt-[94px] md:px-5 w-full">
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <LandingPageFooterbig4 className="bg-blue_gray-900 flex md:flex-col flex-row md:gap-10 gap-[125px] items-start justify-start md:px-10 sm:px-5 px-[165px] py-16 w-auto md:w-full" />
          </div>
        </footer>
      </div>
    </>
